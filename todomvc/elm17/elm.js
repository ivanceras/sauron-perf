...
var _evancz$elm_todomvc$Todo$is13 = function (code) {
...
var _evancz$elm_todomvc$Todo$onEnter = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(
			_elm_lang$core$Json_Decode$map,
			_elm_lang$core$Basics$always(tagger),
			A2(_elm_lang$core$Json_Decode$customDecoder, _elm_lang$html$Html_Events$keyCode, _evancz$elm_todomvc$Todo$is13)));
};
...
var _evancz$elm_todomvc$Todo$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _evancz$elm_todomvc$Todo$emptyModel, update: _evancz$elm_todomvc$Todo$update, view: _evancz$elm_todomvc$Todo$view})
};
