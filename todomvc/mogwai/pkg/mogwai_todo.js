(function() {
    ...
    function __wbg_elem_binding1(arg0, arg1) {
        wasm.__wbg_function_table.get(183)(arg0, arg1);
    }
    /**
    */
...
function init(module) {
    ...
    imports.wbg.__widl_f_set_data_CharacterData = function(arg0, arg1, arg2) {
        getObject(arg0).data = getStringFromWasm(arg1, arg2);
    };
    ...
    imports.wbg.__widl_instanceof_Event = function(arg0) {
    ...
    imports.wbg.__widl_f_new_with_data_Text = function(arg0, arg1) {
        try {
            const ret = new Text(getStringFromWasm(arg0, arg1));
            return addHeapObject(ret);
        } catch (e) {
            handleError(e)
        }
    ...
    imports.wbg.__wbindgen_closure_wrapper628 = function(arg0, arg1, arg2) {
        ...
        const real = () => {
            ...
            try {
                ...
                if (--state.cnt === 0) wasm.__wbg_function_table.get(184)(a, state.b);
                else state.a = a;
            }
        }
        ;
