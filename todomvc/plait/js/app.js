...
},{"./virtual-hyperscript/index.js":10}],8:[function(require,module,exports){
'use strict';
...
},{"ev-store":4}],9:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-thunk":12,"../vnode/is-vhook":13,"../vnode/is-vnode":14,"../vnode/is-vtext":15,"../vnode/is-widget":16,"../vnode/vnode.js":18,"../vnode/vtext.js":19,"./hooks/ev-hook.js":8,"./hooks/soft-set-hook.js":9,"./parse-tag.js":11,"x-is-array":20}],11:[function(require,module,exports){
'use strict';
...
},{"browser-split":2}],12:[function(require,module,exports){
...
},{"./components/TodoApp":24,"plait":34}],22:[function(require,module,exports){
'use strict';
...
},{"../utils/filters":26,"virtual-dom/h":7}],23:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/h":7}],24:[function(require,module,exports){
'use strict';
    ...
    case 'TOGGLE_ALL':
      ...
      return state.update('todos', function (todos) {
        return todos.map(function (todo) {
          return TodoItem.update(todo, todoAction);
        });
      });
  }
}
...
function updateHeader(state, action) {
  var value = action.$event.target.value.trim();

  if ((0, _input.wasEnterKey)(action.$event) && value.length) {
    var _ret = function () {
      var newTodo = initComponent({ init: TodoItem.init(value) });

      return {
        v: state.update('todos', function (todos) {
...
function updateTodoItems(state, action) {
  if (action.$fwdAction.type === 'DELETE') {
    var _ret2 = function () {
      var idx = action.todoIdx;

      return {
        v: state.update('todos', function (todos) {
          return todos.slice(0, idx).concat(todos.slice(idx + 1));
        })
      };
    }();
    ...
    return state.update('todos', function (todos) {
      return todos.map(updateTodoItem(action));
    });
  }
}
...
},{"../utils/filters":26,"../utils/input":27,"../utils/merge":28,"./Footer":22,"./Header":23,"./TodoItem":25,"plait":34,"virtual-dom/h":7}],25:[function(require,module,exports){
'use strict';
...
function update(state, action) {
  switch (action.type) {
    ...
    case 'START_EDIT':
      setTimeout(function () {
        return action.$event.currentTarget.querySelector('.edit').focus();
      }, 20);

      return state.set('editing', true);

    case 'STOP_EDIT':
      if (!(0, _input.wasKeyEvent)(action.$event) || (0, _input.wasEnterKey)(action.$event)) {
...
function view(state, dispatch) {
  var itemClasses = [state.get('completed') ? 'completed' : '', state.get('editing') ? 'editing' : ''].join(' ');

  return (0, _h2.default)('li', { className: itemClasses, 'ev-dblclick': dispatch({ type: 'START_EDIT' }) }, [(0, _h2.default)('div', { className: "view" }, [checkboxView(state, dispatch), (0, _h2.default)('label', null, [state.get('title')]), (0, _h2.default)('button', { className: "destroy", 'ev-click': dispatch({ type: 'DELETE' }) })]), (0, _h2.default)('input', {
    className: "edit",
...
},{"../utils/input":27,"virtual-dom/h":7}],26:[function(require,module,exports){
'use strict';
...
var wasEnterKey = exports.wasEnterKey = function wasEnterKey(event) {
  return event.keyCode === ENTER_KEY;
};

var wasKeyEvent = exports.wasKeyEvent = function wasKeyEvent(event) {
...
},{"./State":30,"./dom/delegator":31,"./dom/virtual-dom":33,"ramda/src/curry":48,"redux":64,"redux-thunk":58}],30:[function(require,module,exports){
'use strict';
...
},{"./utils/clone":35,"ramda/src/assocPath":47,"ramda/src/path":57}],31:[function(require,module,exports){
'use strict';
...
},{"./events":32,"dom-delegator/dom-delegator":37}],32:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/create-element":69,"virtual-dom/diff":70,"virtual-dom/patch":71}],34:[function(require,module,exports){
'use strict';
...
},{"./App":29,"./State":30}],35:[function(require,module,exports){
'use strict';
...
},{"./add-event.js":36,"./proxy-event.js":38,"./remove-event.js":39,"ev-store":40,"global/document":43,"weakmap-shim/create-store":88}],38:[function(require,module,exports){
...
},{"inherits":44}],39:[function(require,module,exports){
var EvStore = require("ev-store")
...
},{"ev-store":40}],40:[function(require,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"dup":4,"individual/one-version":42}],41:[function(require,module,exports){
arguments[4][5][0].apply(exports,arguments)
},{"dup":5}],42:[function(require,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"./index.js":41,"dup":6}],43:[function(require,module,exports){
(function (global){
...
},{"min-document":1}],44:[function(require,module,exports){
...
},{"./internal/_curry3":53}],47:[function(require,module,exports){
var _curry3 = require('./internal/_curry3');
...
},{"./assoc":46,"./internal/_curry3":53,"./internal/_slice":56}],48:[function(require,module,exports){
...
},{"./curryN":49,"./internal/_curry1":51}],49:[function(require,module,exports){
...
},{"./internal/_arity":50,"./internal/_curry1":51,"./internal/_curry2":52,"./internal/_curryN":54}],50:[function(require,module,exports){
...
},{"./_isPlaceholder":55}],52:[function(require,module,exports){
...
},{"./_curry1":51,"./_isPlaceholder":55}],53:[function(require,module,exports){
var _curry1 = require('./_curry1');
...
},{"./_curry1":51,"./_curry2":52,"./_isPlaceholder":55}],54:[function(require,module,exports){
...
},{"./_arity":50,"./_isPlaceholder":55}],55:[function(require,module,exports){
...
},{"./internal/_curry2":52}],58:[function(require,module,exports){
'use strict';
...
},{"./createStore":63,"./utils/warning":65,"_process":3,"lodash/isPlainObject":68}],62:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":68}],64:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":59,"./bindActionCreators":60,"./combineReducers":61,"./compose":62,"./createStore":63,"./utils/warning":65,"_process":3}],65:[function(require,module,exports){
'use strict';
...
},{"./_isHostObject":66,"./isObjectLike":67}],69:[function(require,module,exports){
var createElement = require("./vdom/create-element.js")

module.exports = createElement

},{"./vdom/create-element.js":73}],70:[function(require,module,exports){
var diff = require("./vtree/diff.js")

module.exports = diff

},{"./vtree/diff.js":87}],71:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":80,"is-object":45}],73:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":78,"../vnode/is-vnode.js":81,"../vnode/is-vtext.js":82,"../vnode/is-widget.js":83,"./apply-properties":72,"global/document":43}],74:[function(require,module,exports){
...
},{"../vnode/is-widget.js":83,"../vnode/vpatch.js":85,"./apply-properties":72,"./update-widget":77}],76:[function(require,module,exports){
var document = require("global/document")
var isArray = require("x-is-array")
...
},{"./create-element":73,"./dom-index":74,"./patch-op":75,"global/document":43,"x-is-array":90}],77:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-widget.js":83}],78:[function(require,module,exports){
var isVNode = require("./is-vnode")
...
},{"dup":12}],80:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13}],81:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
},{"./version":84,"dup":14}],82:[function(require,module,exports){
arguments[4][15][0].apply(exports,arguments)
},{"./version":84,"dup":15}],83:[function(require,module,exports){
...
},{"./version":84}],86:[function(require,module,exports){
var isObject = require("is-object")
var isHook = require("../vnode/is-vhook")
...
},{"../vnode/is-vhook":80,"is-object":45}],87:[function(require,module,exports){
var isArray = require("x-is-array")
...
},{"../vnode/handle-thunk":78,"../vnode/is-thunk":79,"../vnode/is-vnode":81,"../vnode/is-vtext":82,"../vnode/is-widget":83,"../vnode/vpatch":85,"./diff-props":86,"x-is-array":90}],88:[function(require,module,exports){
