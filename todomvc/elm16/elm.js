...
Elm.Todo.make = function (_elm) {
   ...
   var todoItem = F2(function (address,todo) {
      return A2($Html.li,
      _U.list([$Html$Attributes.key($Basics.toString(todo.id))
              ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "completed",_1: todo.completed},{ctor: "_Tuple2",_0: "editing",_1: todo.editing}]))]),
      _U.list([A2($Html.div,
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "UpdateField": return _U.update(model,{field: _p4._0});
         case "EditingTask": var updateTask = function (t) {    return _U.eq(t.id,_p4._0) ? _U.update(t,{editing: _p4._1}) : t;};
           return _U.update(model,{tasks: A2($List.map,updateTask,model.tasks)});
         case "UpdateTask": var updateTask = function (t) {    return _U.eq(t.id,_p4._0) ? _U.update(t,{description: _p4._1}) : t;};
           return _U.update(model,{tasks: A2($List.map,updateTask,model.tasks)});
         case "Delete": return _U.update(model,{tasks: A2($List.filter,function (t) {    return !_U.eq(t.id,_p4._0);},model.tasks)});
         case "DeleteComplete": return _U.update(model,
           {tasks: A2($List.filter,function (_p5) {    return $Basics.not(function (_) {    return _.completed;}(_p5));},model.tasks)});
         case "Check": var updateTask = function (t) {    return _U.eq(t.id,_p4._0) ? _U.update(t,{completed: _p4._1}) : t;};
           return _U.update(model,{tasks: A2($List.map,updateTask,model.tasks)});
         case "CheckAll": var updateTask = function (t) {    return _U.update(t,{completed: _p4._0});};
           return _U.update(model,{tasks: A2($List.map,updateTask,model.tasks)});
         default: return _U.update(model,{visibility: _p4._0});}
   });
   var main = $StartApp$Simple.start({model: emptyModel,update: update,view: view});
